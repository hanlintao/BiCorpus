...
$fileid = $_POST["id"];
$description = text_filter($_POST["value"]);

//$references = str_replace("\r\n","<br />",$reference);

//撰写一个更新语句

$sql_update_references = "UPDATE files SET `description` ='{$description}' WHERE `id` = '{$fileid}'";

$update = mysqli_query($conn,$sql_update_references);

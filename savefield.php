...
$fileid = $_POST["id"];
$field = text_filter($_POST["value"]);

//$references = str_replace("\r\n","<br />",$reference);

//撰写一个更新语句

$sql_update_field = "UPDATE files SET `field` ='{$field}' WHERE `id` = '{$fileid}'";

$update = mysqli_query($conn,$sql_update_field);
